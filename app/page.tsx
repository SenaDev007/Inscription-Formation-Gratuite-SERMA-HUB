          ...
          <div className="lg:sticky lg:top-8">
            ...
            >
              {INFO_ITEMS.map((item, i) => (
                ...
                >
                  <span className="text-lg xs:text-xl block mb-1">{item.icon}</span>
            ...
            >
              <div className="flex items-start gap-3">
                <span className="text-orange text-base xs:text-lg flex-shrink-0 mt-0.5">📍</span>
                <div className="min-w-0">
                  ...
                  <p className="text-slate-300 text-xs leading-relaxed break-words">
                    Zongo 2, von AXE BENI CHIC – PRESIDO, à 100 m du
                    carrefour après EPP La SOURCE
                    <br />
                  ...
                  <a
                    href="tel:0140377199"
                    className="inline-flex items-center gap-1 mt-2 text-orange text-xs font-semibold hover:text-orange-hover active:text-orange-hover"
